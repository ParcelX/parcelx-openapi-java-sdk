...
public class ECommerceApi extends BaseParcelxApi implements IECommerceApi {
    ...
    @Override
    public ParcelCreationResult createParcel(CreateParcelParam parcel, boolean autoPlaceOrder) throws ApiException, UnsupportedEncodingException {
        return invoke(new ApiRequest("createParcel", parcel, autoPlaceOrder))
                .getResult(ParcelCreationResult.class);
    }

    @Override
    public void placeOrder(ParcelNoParam parcelNo) throws ApiException, UnsupportedEncodingException {
        invoke(new ApiRequest("placeOrder", parcelNo)).throwExceptionIfHasError();
    }

    @Override
    public ParcelListQueryResult getParcelList(ParcelListQueryParam query) throws ApiException, UnsupportedEncodingException {
    ...
    @Override
    public ParcelTrackingResult getTracking(ParcelNoParam parcelNo) throws ApiException, UnsupportedEncodingException {
        return invoke(new ApiRequest("getTracking", parcelNo))
                .getResult(ParcelTrackingResult.class);
    }

    @Override
    public void fixException(ParcelNoParam parcelNo, FixParcelInfoParam fixParcelInfoParam) throws ApiException, UnsupportedEncodingException {
        invoke(new ApiRequest("fixException", parcelNo, fixParcelInfoParam)).throwExceptionIfHasError();
    }

    @Override
    public void confirmServiceComplete(ParcelNoParam parcelNo) throws ApiException, UnsupportedEncodingException {
